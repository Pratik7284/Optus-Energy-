  ...
  return (
    <div className="bg-white">
      ...
      <section className="py-32 bg-slate-50 border-b border-slate-100">
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
          <div className="max-w-4xl">
            <h1 className="text-xs font-bold uppercase tracking-[0.4em] text-sky-500 mb-8">Operations</h1>
            <h2 className="text-6xl md:text-8xl font-serif font-bold text-slate-900 mb-10 italic leading-tight">Procedures & FAQs</h2>
      ...
      <section className="py-32">
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-12 gap-20">
          <div className="lg:col-span-5">
            <h3 className="text-xs font-bold uppercase tracking-[0.4em] text-slate-400 mb-8">Common Inquiries</h3>
            <h4 className="text-5xl font-serif font-bold text-slate-900 mb-10">Get the Answers You Need</h4>
            <p className="text-lg text-slate-500 leading-relaxed">If you have specific operational questions not covered here, please reach out to our support team.</p>
          </div>
        ...
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            ...
            <div className="group relative">
                <div className="h-[600px] overflow-hidden shadow-2xl">
                    <img 
                ...
                <div className="absolute bottom-0 left-0 p-16 w-full text-white">
                    <h4 className="text-5xl font-serif font-bold mb-6">CIF Supply</h4>
                    <p className="text-xl text-slate-300 font-light mb-8 opacity-0 group-hover:opacity-100 transition-all duration-700 transform translate-y-4 group-hover:translate-y-0">
            ...
            <div className="group relative">
                ...
                <div className="absolute bottom-0 left-0 p-16 w-full text-white">
                    <h4 className="text-5xl font-serif font-bold mb-6">FOB Supply</h4>
                    <p className="text-xl text-slate-300 font-light mb-8 opacity-0 group-hover:opacity-100 transition-all duration-700 transform translate-y-4 group-hover:translate-y-0">
                    ...
                    <div className="w-24 h-1.5 bg-sky-500"></div>
                </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-40 bg-white text-center">
        <div className="max-w-[1440px] mx-auto px-6">
            <h3 className="text-5xl md:text-7xl font-serif font-bold text-slate-900 mb-10 leading-tight">Need Detailed Documentation?</h3>
            <p className="text-slate-600 mb-16 text-2xl font-light max-w-4xl mx-auto leading-relaxed">Our legal and operational teams can provide full procedure documentation and compliance requirements for qualified buyers.</p>
            <a href="#/contact" className="inline-block bg-slate-950 text-white px-16 py-6 font-bold uppercase tracking-[0.3em] text-sm hover:bg-orange-600 transition-all shadow-2xl">
